...
# 8. AGE VS TB OUTCOME (Box Plot Style)

```python
import matplotlib.pyplot as plt
import seaborn as sns

# 1. Build a box plot to examine data distribution benchmarks between groups
sns.boxplot(data=df, x="CultureResult", y="Age", palette="Set3")

# 2. Add clear titles
plt.title("Distribution of Patient Age across TB Culture Outcomes")
plt.xlabel("Culture Test Result")
